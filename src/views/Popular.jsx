...
export default function Popular() {
    ...
    useEffect(() => { getMovies("popular") }, [page])
        ...
        <Container disableGutters maxWidth="xl" sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            <ImageList sx={{ marginTop: "10vh", display: "flex", flexDirection: "column" }}>
                <ImageListItem cols={2}>
                    <ListSubheader component="div" sx={{ backgroundColor: "black", color: "#F5D57B", fontFamily: "Montserrat", fontSize: "2.5vh" }}><Link to={'/home'}>ADA MOVIES</Link> / POPULAR MOVIES</ListSubheader>
                </ImageListItem>
